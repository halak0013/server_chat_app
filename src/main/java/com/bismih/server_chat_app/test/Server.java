...
public class Server {
	...
	{
		// Here we define Server Socket running on port 9000
		try (ServerSocket serverSocket
			= new ServerSocket(9000)) {
			System.out.println(
				"Server is Starting in Port 9000");
			...
			// file
			receiveFile("NewFile1.pdf", dataInputStream);
		...
		throws Exception
	{
		...
		long size
			= sInput.readLong(); // read file size
